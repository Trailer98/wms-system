...
public class WarehouseLocationController {
    ...
    @SysOperationLog(operationType = "创建库位", content = "创建库位", module = "基础资料")
    ...
    @SysOperationLog(operationType = "编辑库位", content = "编辑库位", module = "基础资料")
    ...
    @RequiresPermission("location:disable")
    @SysOperationLog(operationType = "切换库位状态", content = "切换库位状态", module = "基础资料")
    ...
    @DeleteMapping("/{id}")
    @RequiresPermission("location:disable")
    @SysOperationLog(operationType = "删除库位", content = "删除库位", module = "基础资料")
    ...
    @GetMapping
    @RequiresPermission("location:view")
